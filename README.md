...
Welcome to my TinyTapeout project featuring a time-to-digital converter (TDC) circuit implemented using SkyWater SKY130 technology. This mixed-signal design occupies a small tile within the overall chip layout.

![Whole chip](docs/chip.png "Whole chip")
...
![TDC circuit](docs/tdc.png "TDC circuit")
...
![Circuit architecture](docs/architecture.png "Cricuit architecture")
...
![TDC term_4 output simulation](docs/term_4.png "TDC term_4 output simulation")

Once the phase difference that triggers each TDC output is determined, a transfer curve can be plotted, as shown below.

![TDC transfer curve](docs/transfer_curve.png "TDC transfer curve")
...
![Coarse delay](docs/coarse_delay.png "Coarse delay")

![Fine delay](docs/fine_delay.png "Fine delay")
